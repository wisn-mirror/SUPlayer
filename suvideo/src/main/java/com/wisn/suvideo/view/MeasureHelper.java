...
public class MeasureHelper {
    ...
    public int[] doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (mCurrentScreenScale) {
            case SuVideoView.SCREEN_SCALE_ORIGINAL:
                width = mVideoWidth;
                height = mVideoHeight;
                break;
            case SuVideoView.SCREEN_SCALE_16_9:
                ...
                break;
            case SuVideoView.SCREEN_SCALE_4_3:
                if (height > width / 4 * 3) {
                    height = width / 4 * 3;
                } else {
                    width = height / 3 * 4;
...
//                Log.d("@@@@", "onMeasure 4:3 : width" + width + "    height:" + height);
                break;
            case SuVideoView.SCREEN_SCALE_MATCH_PARENT:
                width = widthMeasureSpec;
                height = heightMeasureSpec;
                break;
            case SuVideoView.SCREEN_SCALE_CENTER_CROP:
                ...
                break;
            case SuVideoView.SCREEN_SCALE_DEFAULT:
            default:
                if (mVideoWidth > 0 && mVideoHeight > 0) {
